...
# Example usage
df = pd.read_csv(r'C:\Users\ehild\OneDrive\Documents\2021-03-05_ADAUSDT.csv')
#C:\Users\ehild\Desktop\dqn_backup\datasets
bid_prices, bid_amounts, ask_prices, ask_amounts = process_data(df)
...
env = DummyVecEnv([lambda: MarketMakingEnvironment(bid_prices, bid_amounts, ask_prices, ask_amounts)])
